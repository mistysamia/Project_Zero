...
public class GameThirdPage extends AppCompatActivity {

    public int counter2,cou2;
    public int lock3=0;
    int val=0;
    Bundle bundle ;
    String username;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_third_page);
        bundle=getIntent().getExtras();
        username=bundle.getString("Tag");
        val = getIntent().getIntExtra("TheScore",0);

        button1=(Button)findViewById(R.id.ques131);
        button2=(Button)findViewById(R.id.ques132);
        button3=(Button)findViewById(R.id.ques133);
        button4=(Button)findViewById(R.id.ques134);
            ...
            public void onFinish() {
                if(lock3==0)
                {
                    ...
                    new CountDownTimer(3000, 2000) {
                        ...
                        @Override
                        public void onFinish() {
                            Intent intent =new Intent(GameThirdPage.this,GameFourPage.class);
        ...
        button1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(v.getId()==R.id.ques131 && lock3==0)
                {
                    lock3=1;val=val-2;
                    LayoutInflater inflater=getLayoutInflater();
        ...
        button2.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v) {
                if(v.getId()==R.id.ques132 && lock3==0)
                {
                    lock3=1;val=val-2;
                    LayoutInflater inflater=getLayoutInflater();
                    @SuppressLint("WrongViewCast") View layout =inflater.inflate(R.layout.toast_wrong,(ViewGroup) findViewById(R.id.textViewToast));
        ...
        button3.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v) {
                if(v.getId()==R.id.ques133 && lock3==0)
                {
                    lock3=1;val=val-2;
                    LayoutInflater inflater=getLayoutInflater();
                    @SuppressLint("WrongViewCast") View layout =inflater.inflate(R.layout.toast_wrong,(ViewGroup) findViewById(R.id.textViewToast));
        ...
        button4.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v) {
                if(v.getId()==R.id.ques134 && lock3==0)
                {
                    lock3=1;val=val+2;
                    LayoutInflater inflater=getLayoutInflater();
